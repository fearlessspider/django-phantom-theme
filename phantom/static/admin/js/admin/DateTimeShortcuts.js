...
var DateTimeShortcuts = {
    ...
    addClock: function(inp) {
        ...
        phantom.jQuery(inp).closest('.modal, body').append(clock_box);
        ...
        phantom.jQuery(document).bind('keyup', function(event) {
            if (event.which == 27) {
    ...
    addCalendar: function(inp) {
        ...
        phantom.jQuery(inp).closest('.modal, body').append(cal_box);
